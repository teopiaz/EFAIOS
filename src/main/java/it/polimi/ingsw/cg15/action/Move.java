...
/**
 * @author MMP - LMR 
 * This class extends the class action and is therefore one of the possible actions 
 * to be taken during a turn. In particular, it is the action that allows the player 
 * to move to a cell in the map. Also, if the selected cell is a dangerous sector it
 *  is concerned to call the functionality that allows you to draw a card sector.
 */
public class Move extends Action {
    ...
    /**
     * Allows the player to move to a cell in the map. Also, if the selected cell is
     * a dangerous sector it is concerned to call the functionality that allows you
     * to draw a card sector.
