...
public class App {
    ...
    public static void main(String[] args) {
        ...
        /*
         * List<SectorCard> sec = DeckContainer.getSectorDeck(); List<ItemCard>
         * item = DeckContainer.getItemDeck();
         * 
         ...
         * System.out.println(sectorCard.hasItemIcon() +" "+
         * sectorCard.getClass().toString());
         * 
         * }
         * 
         ...
         * }
         * 
         * while(DeckContainer.itemCounter()>1){ DeckContainer.getItemCard(); }
         * ItemCard card = DeckContainer.getItemCard(); System.out.println(card
         * + " ultima"); DeckContainer.discardItemCard(card); card =
         * DeckContainer.getItemCard(); System.out.println(card +
         * " rimessa e ripescata");
         */
        ...
        System.out.println(CELLA1.getCoordinate().getDistance(
                CELLA2.getCoordinate()));
